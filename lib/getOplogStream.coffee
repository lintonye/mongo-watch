...
module.exports = ({host, port, dbOpts, serverOpts, dbListeners, username, password, useMasterOplog, authdb, replicaSet}, done) ->
  connect {db: 'local', host, port, dbOpts, serverOpts, dbListeners, username, password, authdb, replicaSet}, (err, oplogClient) =>
