...
module.exports = ({host, port, dbOpts, serverOpts, username, password, useMasterOplog, authdb, replicaSet}, done) ->
  connect {db: 'local', host, port, dbOpts, serverOpts, username, password, authdb, replicaSet}, (err, oplogClient) =>
